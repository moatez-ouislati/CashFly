...
class Operation
{
    ...
    #[ORM\Column(name: 'notes_interne', type: Types::TEXT, nullable: true)]
    #[Assert\Length(max: 5000, maxMessage: 'Les notes internes ne peuvent pas dépasser {{ limit }} caractères')]
    ...
    public function setNotesInterne(?string $notesInterne): self
    {
