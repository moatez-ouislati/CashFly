...
class getTwigService extends App_KernelDevDebugContainer
{
    ...
    {
        $a = new \Twig\Loader\FilesystemLoader([], 'C:\\cashfly-web-symfony');
        $a->addPath('C:\\cashfly-web-symfony\\vendor\\symfony\\maker-bundle/templates', 'Maker');
        $a->addPath('C:\\cashfly-web-symfony\\vendor\\symfony\\maker-bundle/templates', '!Maker');
        $a->addPath('C:\\cashfly-web-symfony\\vendor\\doctrine\\doctrine-bundle/templates', 'Doctrine');
        $a->addPath('C:\\cashfly-web-symfony\\vendor\\doctrine\\doctrine-bundle/templates', '!Doctrine');
        $a->addPath('C:\\cashfly-web-symfony\\vendor\\doctrine\\doctrine-migrations-bundle/templates', 'DoctrineMigrations');
        $a->addPath('C:\\cashfly-web-symfony\\vendor\\doctrine\\doctrine-migrations-bundle/templates', '!DoctrineMigrations');
        $a->addPath('C:\\cashfly-web-symfony\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $a->addPath('C:\\cashfly-web-symfony\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $a->addPath('C:\\cashfly-web-symfony\\vendor\\friendsofsymfony\\elastica-bundle\\src/Resources/views', 'FOSElastica');
        $a->addPath('C:\\cashfly-web-symfony\\vendor\\friendsofsymfony\\elastica-bundle\\src/Resources/views', '!FOSElastica');
        $a->addPath('C:\\cashfly-web-symfony/templates');
        $a->addPath('C:\\cashfly-web-symfony\\vendor\\symfony\\twig-bridge/Resources/views/Form');
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(($container->privates['debug.file_link_formatter'] ??= new \Symfony\Component\ErrorHandler\ErrorRenderer\FileLinkFormatter($container->getEnv('default::SYMFONY_IDE'))), 'C:\\cashfly-web-symfony', 'UTF-8'));
