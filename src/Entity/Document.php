...
#[ORM\Table(name: 'documents', indexes: [new ORM\Index(name: 'fk_documents_entreprise', columns: ['id_entreprise'])])]
class Document
{
    ...
    #[ORM\Column(name: 'commentaire', type: Types::TEXT, nullable: true, columnDefinition: 'TEXT DEFAULT NULL')]
