...
public class Entreprise {
    ...
    public Entreprise(int idEntreprise, String nom, String secteur, String formeJuridique, LocalDate dateCreation, BigDecimal capital, int idProprietaire, double latitude, double longitude, String adresse) {
    ...
    public Entreprise(String nom, String secteur, String formeJuridique, LocalDate dateCreation, double capital, int idProprietaire) {
        this.nom.set(nom);
        this.secteur.set(secteur);
        this.formeJuridique.set(formeJuridique);
        this.dateCreation.set(dateCreation);
        this.capital.set(BigDecimal.valueOf(capital));
        this.idProprietaire.set(idProprietaire);
    }

    public Entreprise(int idEntreprise, String nom, String secteur, String formeJuridique, LocalDate dateCreation, double capital, int idProprietaire) {
        this.idEntreprise.set(idEntreprise);
        this.nom.set(nom);
        this.secteur.set(secteur);
        this.formeJuridique.set(formeJuridique);
