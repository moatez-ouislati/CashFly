...
/**
 * Banque Centrale de Tunisie - Official Exchange Rates API
 * Source: https://www.bct.gov.tn/
...
public class BctExchangeRateService {
    ...
    public Map<String, ExchangeRate> getTodayExchangeRates() throws Exception {
        ...
        for (String currencyCode : rates.keySet()) {
            ...
            // The API returns how much of foreign currency 1 TND buys.
            // Inverse it to get how many TND 1 unit of foreign currency costs.
