...
class AiRecommendationService
{
    ...
    // Keys are now provided by AiKeyProvider for security and rotation.
    private const MODEL = 'gpt-4o-mini';
    private const OPENROUTER_URL = 'https://openrouter.ai/api/v1/chat/completions';

    private AiKeyProvider $keyProvider;

    public function __construct(AiKeyProvider $keyProvider)
    {
...
Les recommandations doivent être en français, pertinentes pour le marché tunisien et Maghreb.";
    ...
    private function callOpenAI(string $prompt): ?string
    {
        ...
        return $this->makeApiCall(self::OPENAI_URL, $data, $this->keyProvider->getOpenAiKey());
    }
    ...
    private function callOpenRouter(string $prompt): ?string
    {
        ...
        return $this->makeApiCall(self::OPENROUTER_URL, $data, $this->keyProvider->getOpenRouterKey());
    }
