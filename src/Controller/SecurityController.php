...
class SecurityController extends AbstractController
{
    ...
    public function faceVerify(): Response
    {
        ...
        return $this->render('admin/face_verification.html.twig');
    }

    #[Route('/admin/face-verify-success', name: 'app_admin_face_verify_success', methods: ['POST'])]
    public function faceVerifySuccess(Request $request): JsonResponse
    {
        if (!$this->isGranted('ROLE_ADMIN')) {
    ...
    {
        if ($this->isGranted('ROLE_ADMIN')) {
            // Temporarily bypassing face verify
