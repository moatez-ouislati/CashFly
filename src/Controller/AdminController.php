...
public function exportPdf(UserRepository $repo, DompdfFactoryInterface $factory): Response
{
    // 1. Njibou el data
    $users = $repo->findAll();

    // 2. Render el HTML (nesta3mlou el template mte3ek 'admin/pdf.html.twig')
    $html = $this->renderView('admin/pdf.html.twig', [
        'users' => $users
    ]);

    // 3. El khidma bel Factory mta3 el Bundle
