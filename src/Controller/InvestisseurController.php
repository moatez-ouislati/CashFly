...
// نحددوا المسار (Path) متاع التصويرة في الـ Dossier متاعك
$imagePath = $this->getParameter('face_images_directory') . '/' . $user->getFaceImage();

// --- إرسال إيميل للأدمن مع التصويرة ---
$email = (new Email())
...
// نزيدو السطر هذا باش نبعثو التصويرة كـ Pièce Jointe
...
// ... الباقي متاع الكود
        ...
        return $this->render('investisseur/profile.html.twig', ['form' => $form, 'user' => $user]);
    }
}